...
import type { UpdateIdentityResourceInput } from '@/fetch/apis/identity-resource';
              ...
              v-decorator={[
                'name',
                {
                  rules: [
                    ...
                    {
                      pattern: /^[a-zA-Z.]+$/,
                      message: i18n.tv('identity_resource_form.name_pattern', '只允许英文字母或“.”'),
                    },
                    {
                      max: 50,
                      message: i18n.tv('identity_resource_form.name_max_length', '长度不能超过50个字符', {
                        length: 50,
                      }),
                    },
                  ],
