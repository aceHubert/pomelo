...
import type { ApiScopeClaimsModel } from '@/admin/fetch/api-resource';
...
export default Form.create({})(
  defineComponent({
    ...
    setup(props: ApiScopeClaimProps) {
      ...
      const apiResourceId = ref<number>();
      const apiScopeName = ref<string>();
      const $scopeClaimsRes = createResource((apiScopeId: number) => {
                    ...
                    routeBreadcrumb = routeBreadcrumb.map((item) => {
                      if (item.key === 'api-scopes' && apiResourceId.value) {
                        ...
                        return route
                          ? {
                              ...item,
                              path: router.resolve({ params: { id: String(apiResourceId.value) } }, route).href,
                            }
                          : item;
                      }
                      return item;
