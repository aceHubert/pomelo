...
import IconTags from '@admin/assets/icons/tags.svg?inline';
import IconAddCell from '@admin/assets/icons/add-cell.svg?inline';
import IconDesign from '@admin/assets/icons/design.svg?inline';
import IconPage from '@admin/assets/icons/page.svg?inline';
import IconArticle from '@admin/assets/icons/article.svg?inline';
import IconSurvey from '@admin/assets/icons/survey.svg?inline';
import IconDetails from '@admin/assets/icons/details.svg?inline';
import IconComponent from '@admin/assets/icons/component.svg?inline';
import IconSettings from '@admin/assets/icons/settings.svg?inline';
import IconScope from '@admin/assets/icons/scope.svg?inline';
