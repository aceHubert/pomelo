...
import { useUserManager, usePubSubMessages, useI18n } from '@/hooks';
...
import type { MenuConfig, MessageConfig } from '@/types';
import type { BreadItem } from './modules/global-header/Breadcrumb';
