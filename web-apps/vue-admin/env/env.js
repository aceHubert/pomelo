(function (window) {
  ...
  env.apiBase = 'https://tpl.acehubert.com/api';
  env.graphqlBase = 'https://tpl.acehubert.com/graphql';
  env.graphqlSubscriptionBase = 'wss://tpl.acehubert.com/graphql';

  env.oidc = {
    authority: 'https://auth.acehubert.com/',
