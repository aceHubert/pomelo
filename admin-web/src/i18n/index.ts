...
import { LOCALE_KEY } from '@/configs/settings.config';
...
export const defaultLocale = storage.get<string>(LOCALE_KEY, 'zh-CN');
export const fallbackLocale = 'zh-CN';
export const supportLanguages: LocaleConfig[] = [
  {
    name: 'English',
    shortName: 'EN',
    icon: '🇺🇸',
