...
export class RAMStatement {
   ...
   * &lt;prefix&gt;:&lt;service-name&gt;:&lt;relative-id&gt;
   * prefix: 资源前缀，默认为 po (pomelo 的首字母缩写)，可通过 resourcePrefix 配置。
   * service-name: pomelo 提供的API服务名称，如 ips, cp 等。
   ...
   * 描述样例：
   * "Resource": ["po:isp:article/001", "po:cp:product/*"]
   */
  Resource?: string[];
