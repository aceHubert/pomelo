 ...
 */
export const useBasicApi = defineRegistApi('__SUBMODULES__', {
  apis: {
    getOptionValue: typedUrl<string, { name: string }>`/options/${'name'}/value`,
    getAutoloadOptions: typedUrl<Record<string, string>>`/options/autoload`,
  },
